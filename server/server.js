...
app.post('/api/chat', async (req, res) => {
  ...
  // Groq's API is OpenAI-compatible, so we build a standard messages array:
  // system prompt first, then the existing conversation, then the new
  // student message. No SDK needed — plain fetch to their REST endpoint.
  const messages = [
